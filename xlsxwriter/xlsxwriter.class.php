...
class XLSXWriter
{
    ...
    public function setColumnsOptions($sheet_name, array $header_types, $col_options = null )
    {
    ...
    public function writeSheetHeader($sheet_name, array $header_types, $col_options = null, $row=1 )
    {
    ...
    public function writeSheetRow($sheet_name, array $row, $row_options=null, $column_types=null )
    {
      	if (empty($sheet_name))
      	    return;
        ...
        if( !empty($column_types) )
            $sheet->columns = $this->initializeColumnTypes($column_types);
